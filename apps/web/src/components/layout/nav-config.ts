    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Biên bản bàn giao', path: '/machines/handovers', icon: 'fe fe-file-text' },
          { label: 'Chứng chỉ, kiểm định', path: '/machines/certificates', icon: 'fe fe-shield' },
          { label: 'Định mức bảo dưỡng', path: '/machines/norms', icon: 'fe fe-sliders' },
          { label: 'Phiếu báo hỏng', path: '/machines/breakdowns', icon: 'fe fe-alert-octagon' },
          { label: 'Biên bản sự cố', path: '/machines/incidents', icon: 'fe fe-alert-triangle' },
          { label: 'Phiếu sửa chữa', path: '/machines/repair-orders', icon: 'fe fe-tool' },
          { label: 'Dự tính bảo dưỡng', path: '/machines/maintenance-forecast', icon: 'fe fe-trending-up' },
          { label: 'Yêu cầu bảo dưỡng', path: '/machines/maintenance-requests', icon: 'fe fe-inbox' },
          { label: 'Kế hoạch bảo dưỡng', path: '/machines/maintenance-plans', icon: 'fe fe-calendar' },
          { label: 'Kế hoạch sửa chữa', path: '/machines/repair-plans', icon: 'fe fe-calendar' },
          { label: 'Phiếu bảo dưỡng', path: '/machines/maintenance-orders', icon: 'fe fe-settings' },
          { label: 'Lịch sử bảo dưỡng', path: '/machines/maintenance', icon: 'fe fe-clock' },
          ...
          { label: 'Tồn kho phụ tùng', path: '/machines/stocks', icon: 'fe fe-database' },
          { label: 'Yêu cầu mua vật tư', path: '/machines/part-requests', icon: 'fe fe-shopping-cart' },
          { label: 'Thống kê hoạt động', path: '/machines/statistics', icon: 'fe fe-bar-chart-2' },
        ],
      },
    ],
  },
